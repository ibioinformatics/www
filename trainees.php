...
<table width="801" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr><td width="129" height="42" valign="top"><?php include('menu.html');?> </td>
	...
	<table width="100%"> <tr>
    <td colspan="5" bgcolor="#FFFFFF"  style="border-bottom:#0066FF medium groove; font:Geneva, Arial, Helvetica, sans-serif; font-size:14px" align="center"><strong>                  Trainees at IOB</strong></td>
